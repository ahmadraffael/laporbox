...
<div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-4">
    ...
    <div class="col-span-3 grid grid-cols-1 gap-4">
        ...
        <?php else : ?>
            ...
            ?>
                <div class="border-2 rounded-lg border-gray-300 dark:border-gray-600 h-fit mb-4">
    ...
    <div class="border-blue-600 border-4 rounded-lg shadow h-fit flex-col justify-between col-span-1 md:col-span-1 hidden md:block">
        <div class="p-5">
            <h5 class="mb-2 text-2xl font-semibold tracking-tight text-gray-600">Breaking News!!</h5>
        </div>
        <img class="rounded-2xl w-5/6 h-48 text-center mx-auto" src="assets/images/esteh.webp" alt="penjual esteh" />
        <div class="p-5">
            <h5 class="mb-2 text-2xl font-bold tracking-tight text-gray-600">ADA KYAI PALSU!</h5>
            <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Baru-baru ini ramai tentang Gus Miftah yang mengejek "GOBLOK" kepada pedagang es teh. Bermula dari...</p>
