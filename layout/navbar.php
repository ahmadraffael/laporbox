        ...
        <div class="flex flex-wrap justify-between items-center ">
            <div class="flex justify-start items-center">
                ...
                <a href="/" class="flex items-center justify-between mr-4">
                    <img src="../assets/images/logo.png" class="mr-16 h-8 hidden md:inline" alt="Logo" />
                </a>

                <!-- Tab Name -->
                <h4 class="hidden lg:block lg:text-2xl font-bold text-primary ml-16 text-blue-500 "><?= ucwords($_GET['page']) ?></h4>
